...
#       
#     plt.tight_layout()
#     plt.savefig(f'../plots/single-coil_tilt_{i}.png', dpi=300)
#     #plt.show()
#     plt.clf()
    ...
    plt.plot(z, Lz, linewidth=1, label=f'{tilt} degs')
...
plt.legend()
plt.savefig(f'../plots/single-coil_Lz_all.png', dpi=300)


#param tilt=$counter/10*(-0.0025)*180/$pi
