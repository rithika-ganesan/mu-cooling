# Read g4beamline ascii output from a single .txt file and plot Bz vs z
# Takes slices of full-input and then plots subfigures for each slice
...
plt.xlabel('z (mm)')
plt.ylabel('$B_z$ (T)')
plt.title('$B_z$ vs. z (Flipped solenoid)')
plt.show()
